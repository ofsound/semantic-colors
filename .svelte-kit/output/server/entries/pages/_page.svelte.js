...
import { R as attr, a as ensure_array_like, i as derived, n as attr_class, o as head, r as attr_style, z as escape_html } from "../../chunks/dev.js";
...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`</label> <label class="checkbox-row compact svelte-1uha8ag"><input${attr("checked", manifest.alt.harmonyLock, true)} type="checkbox" class="svelte-1uha8ag"/> <span>Lock harmony</span></label></div> <div${attr_class(`mode-block ${activeMode === "alt" ? "mode-block-promoted" : ""}`, "svelte-1uha8ag")}><div class="slider-row svelte-1uha8ag"><span>Hue shift</span> <input max="180" min="-180" step="1" type="range"${attr("value", manifest.alt.delta.h)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="180" min="-180" step="1" type="number"${attr("value", manifest.alt.delta.h)}/></div> <div class="slider-row svelte-1uha8ag"><span>Chroma shift</span> <input max="0.16" min="-0.16" step="0.005" type="range"${attr("value", manifest.alt.delta.c)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="0.16" min="-0.16" step="0.005" type="number"${attr("value", manifest.alt.delta.c)}/></div> <div class="slider-row svelte-1uha8ag"><span>Lightness shift</span> <input max="0.2" min="-0.2" step="0.01" type="range"${attr("value", manifest.alt.delta.l)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="0.2" min="-0.2" step="0.01" type="number"${attr("value", manifest.alt.delta.l)}/></div></div></section> <section class="panel svelte-1uha8ag"><div class="panel-header svelte-1uha8ag"><div><p class="eyebrow svelte-1uha8ag">Token editor</p> <h2 class="svelte-1uha8ag">${escape_html(selectedToken().label)}</h2></div> <span class="token-group svelte-1uha8ag">${escape_html(selectedToken().group)}</span></div> <p class="description svelte-1uha8ag">${escape_html(selectedToken().description)}</p> <div class="swatch-row svelte-1uha8ag"><button class="swatch-card svelte-1uha8ag"><span>Light</span> <span class="swatch svelte-1uha8ag"${attr_style(`background:${toCssColor(selectedToken().light)}`)}></span> <code class="svelte-1uha8ag">${escape_html(toCssColor(selectedToken().light))}</code></button> <button class="swatch-card svelte-1uha8ag"><span>Dark</span> <span class="swatch svelte-1uha8ag"${attr_style(`background:${toCssColor(selectedToken().dark)}`)}></span> <code class="svelte-1uha8ag">${escape_html(toCssColor(selectedToken().dark))}</code></button> <button class="swatch-card svelte-1uha8ag"><span>Alt</span> <span class="swatch svelte-1uha8ag"${attr_style(`background:${toCssColor(currentTokenAlt())}`)}></span> <code class="svelte-1uha8ag">${escape_html(toCssColor(currentTokenAlt()))}</code></button></div> <div${attr_class(`anchor-editor ${activeMode === "light" ? "anchor-editor-active" : ""}`, "svelte-1uha8ag")}><div class="anchor-header svelte-1uha8ag"><strong>Light anchor</strong> <span>${escape_html(activeMode === "light" ? "Editing focus" : "Anchor remains inspectable")}</span></div> <div class="channel-grid svelte-1uha8ag"><label class="channel svelte-1uha8ag"><span>L</span> <input max="1" min="0" step="0.005" type="range"${attr("value", selectedToken().light.l)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="1" min="0" step="0.005" type="number"${attr("value", selectedToken().light.l)}/></label> <label class="channel svelte-1uha8ag"><span>C</span> <input max="0.37" min="0" step="0.005" type="range"${attr("value", selectedToken().light.c)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="0.37" min="0" step="0.005" type="number"${attr("value", selectedToken().light.c)}/></label> <label class="channel svelte-1uha8ag"><span>H</span> <input max="360" min="0" step="1" type="range"${attr("value", selectedToken().light.h)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="360" min="0" step="1" type="number"${attr("value", selectedToken().light.h)}/></label></div></div> <div${attr_class(`anchor-editor ${activeMode === "dark" ? "anchor-editor-active" : ""}`, "svelte-1uha8ag")}><div class="anchor-header svelte-1uha8ag"><strong>Dark anchor</strong> <span>${escape_html(activeMode === "dark" ? "Editing focus" : "Anchor remains inspectable")}</span></div> <div class="channel-grid svelte-1uha8ag"><label class="channel svelte-1uha8ag"><span>L</span> <input max="1" min="0" step="0.005" type="range"${attr("value", selectedToken().dark.l)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="1" min="0" step="0.005" type="number"${attr("value", selectedToken().dark.l)}/></label> <label class="channel svelte-1uha8ag"><span>C</span> <input max="0.37" min="0" step="0.005" type="range"${attr("value", selectedToken().dark.c)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="0.37" min="0" step="0.005" type="number"${attr("value", selectedToken().dark.c)}/></label> <label class="channel svelte-1uha8ag"><span>H</span> <input max="360" min="0" step="1" type="range"${attr("value", selectedToken().dark.h)} class="svelte-1uha8ag"/> <input class="number-field svelte-1uha8ag" max="360" min="0" step="1" type="number"${attr("value", selectedToken().dark.h)}/></label></div></div> <div${attr_class(`mode-block ${activeMode === "alt" ? "mode-block-promoted" : ""}`, "svelte-1uha8ag")}><div class="field-grid svelte-1uha8ag"><label class="field-block svelte-1uha8ag"><span>Alt behavior</span> `);
		$$renderer.select({
			value: selectedToken().exception.altBehavior,
			class: ""
		}, ($$renderer) => {
		...
		$$renderer.push(`</label> <label class="field-block svelte-1uha8ag"><span>Max chroma</span> <input${attr("value", selectedToken().exception.maxChroma)} max="0.37" min="0" step="0.005" type="number" class="svelte-1uha8ag"/></label></div> `);
		if (selectedToken().altParent) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<p class="microcopy svelte-1uha8ag">Alt derives from parent token: <strong>${escape_html(tokenLabel(selectedToken().altParent))}</strong></p>`);
		} else $$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></div> <div class="validation-list svelte-1uha8ag"><p class="eyebrow svelte-1uha8ag">Validation</p> `);
		if (summarizeTokenValidation(selectedTokenValidation()).length === 0) {
			$$renderer.push("<!--[0-->");
			$$renderer.push(`<p class="validation-ok svelte-1uha8ag">No warnings for this token in ${escape_html(activeMode)} mode.</p>`);
		} else {
			$$renderer.push("<!--[-1-->");
			$$renderer.push(`<!--[-->`);
			...
			for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
				...
				$$renderer.push(`<p class="validation-issue svelte-1uha8ag">${escape_html(note)}</p>`);
			}
			$$renderer.push(`<!--]-->`);
		}
		$$renderer.push(`<!--]--></div></section> <section class="panel svelte-1uha8ag"><div class="panel-header svelte-1uha8ag"><div><p class="eyebrow svelte-1uha8ag">Local aliases</p> <h2 class="svelte-1uha8ag">Project-specific names</h2></div> <button class="ghost-button svelte-1uha8ag">Add alias</button></div> <div class="alias-list svelte-1uha8ag"><!--[-->`);
		const each_array_1 = ensure_array_like(manifest.aliases);
		for (let index = 0, $$length = each_array_1.length; index < $$length; index++) {
			let alias = each_array_1[index];
			$$renderer.push(`<div class="alias-row svelte-1uha8ag"><input${attr("value", alias.name)} class="svelte-1uha8ag"/> `);
			$$renderer.select({
				value: alias.tokenId,
			...
			$$renderer.push(` <button class="ghost-button svelte-1uha8ag">Remove</button></div>`);
		}
		$$renderer.push(`<!--]--></div></section> <section class="panel svelte-1uha8ag"><div class="panel-header svelte-1uha8ag"><div><p class="eyebrow svelte-1uha8ag">Import and migration</p> <h2 class="svelte-1uha8ag">CSS review queue</h2></div> <button class="ghost-button svelte-1uha8ag">Reset manifest</button></div> <label class="field-block svelte-1uha8ag"><span>Source CSS path</span> <input${attr("value", config.importSourcePath)} placeholder="../project/src/app.css" class="svelte-1uha8ag"/></label> <div class="action-row svelte-1uha8ag"><button${attr("disabled", !config.importSourcePath, true)} class="svelte-1uha8ag">${escape_html("Scan CSS variables")}</button> `);
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></div> `);
		$$renderer.push("<!--[-1-->");
		$$renderer.push(`<!--]--></section></aside> <main class="stage-shell svelte-1uha8ag"><header class="stage-header svelte-1uha8ag"><div><p class="eyebrow svelte-1uha8ag">Preview harness</p> <h2 class="svelte-1uha8ag">Standalone fixture app + live token inventory</h2></div> <div class="stage-meta svelte-1uha8ag"><span>Mode: ${escape_html(activeMode)}</span> <span>Selected: ${escape_html(selectedToken().label)}</span></div></header> <section${attr_class("stage svelte-1uha8ag", void 0, { "grayscale": manifest.alt.grayscalePreview })}${attr("data-theme", activeMode)}${attr_style(stageStyle())}><div class="hero-grid svelte-1uha8ag"><button${attr_class("surface-card surface-card-app svelte-1uha8ag", void 0, {
		...
		for (let $$index_5 = 0, $$length = each_array_5.length; $$index_5 < $$length; $$index_5++) {
			...
			$$renderer.push(`<button${attr_class(`text-sample text-sample-${tokenId}`, "svelte-1uha8ag", {
		...
		$$renderer.push(`<!--]--></div></article> <article class="fixture-panel svelte-1uha8ag"><div class="fixture-panel-header svelte-1uha8ag"><h3 class="svelte-1uha8ag">Accent and links</h3> <span>Interactive emphasis and tinting</span></div> <div class="accent-grid svelte-1uha8ag"><!--[-->`);
		const each_array_6 = ensure_array_like(accentInventory);
		for (let $$index_6 = 0, $$length = each_array_6.length; $$index_6 < $$length; $$index_6++) {
			let tokenId = each_array_6[$$index_6];
			$$renderer.push(`<button${attr_class(`accent-sample accent-sample-${tokenId}`, "svelte-1uha8ag", {
				"selected-usage": isSelectedUsage([tokenId]),
				"warning": hasWarnings([tokenId])
			})}><span>${escape_html(tokenLabel(tokenId))}</span></button>`);
		}
		$$renderer.push(`<!--]--></div></article> <article class="fixture-panel svelte-1uha8ag"><div class="fixture-panel-header svelte-1uha8ag"><h3 class="svelte-1uha8ag">Status pairs</h3> <span>Surface + text combinations</span></div> <div class="status-grid svelte-1uha8ag"><!--[-->`);
		...
		for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
			...
			$$renderer.push(`<button${attr_class(`status-card status-card-${stem}`, "svelte-1uha8ag", {
		...
		$$renderer.push(`<!--]--></div></article> <article class="fixture-panel svelte-1uha8ag"><div class="fixture-panel-header svelte-1uha8ag"><h3 class="svelte-1uha8ag">Controls</h3> <span>Primary, secondary, ghost, and field states</span></div> <div class="control-grid svelte-1uha8ag"><button${attr_class("control-primary svelte-1uha8ag", void 0, {
		...
		for (let $$index_8 = 0, $$length = each_array_8.length; $$index_8 < $$length; $$index_8++) {
			...
			$$renderer.push(`<button${attr_class(`border-sample border-sample-${tokenId}`, "svelte-1uha8ag", {
				"selected-usage": isSelectedUsage([tokenId]),
				"warning": hasWarnings([tokenId])
			})}>${escape_html(tokenLabel(tokenId))}</button>`);
		}
		$$renderer.push(`<!--]--></div></article> <article class="fixture-panel fixture-panel-overlay svelte-1uha8ag"><div class="fixture-panel-header svelte-1uha8ag"><h3 class="svelte-1uha8ag">Overlay and scrim</h3> <span>Shared overlay pattern with only core tokens</span></div> <div class="overlay-demo svelte-1uha8ag"><div class="scrim svelte-1uha8ag"></div> <button${attr_class("overlay-card svelte-1uha8ag", void 0, {
			"selected-usage": isSelectedUsage([
				"surface-overlay",
				"text",
				"border"
		...
		for (let $$index_10 = 0, $$length = each_array_9.length; $$index_10 < $$length; $$index_10++) {
			...
			$$renderer.push(`<div class="inventory-group svelte-1uha8ag"><div class="inventory-group-header svelte-1uha8ag"><h4 class="svelte-1uha8ag">${escape_html(group)}</h4> <span>${escape_html(TOKENS_BY_GROUP[group].length)} tokens</span></div> <div class="inventory-grid svelte-1uha8ag"><!--[-->`);
			...
			for (let $$index_9 = 0, $$length = each_array_10.length; $$index_9 < $$length; $$index_9++) {
				...
				$$renderer.push(`<button${attr_class("inventory-card svelte-1uha8ag", void 0, {
					"selected-usage": isSelectedUsage([tokenId]),
					"warning": hasWarnings([tokenId])
		...
		$$renderer.push(`<!--]--></article></section></main></div>`);
	});
}
//#endregion
