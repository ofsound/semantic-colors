...
function parseCandidateValues(rawValue: string): { light?: OklchColor | null; dark?: OklchColor | null } {
...
function suggestToken(sourceName: string): Omit<ImportCandidate, 'sourceName' | 'rawValue' | 'light' | 'dark'> {
